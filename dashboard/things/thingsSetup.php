...
<body style="background: #333333">
	...
	<div class="main-page">
		<div class="menu shadow">
			...
			<div class="menu-item only-mobile-block logout-button"
		...
		<div class="dashboard">
			...
			<div class="notice-board shadow">
				<div>
					<h2 class="template-title" style="display: inline">Things Setup</h2>
					<a href="/polis/dashboard/things/addThing.php"><button
							class="add-button">Add Thing</button></a>
				</div>
			</div>
		</div>
